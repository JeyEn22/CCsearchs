  ...
  <div class="container">
    ...
    <div class="left-section">
      <div class="content-box">
        <img src="../image/Icon.png" alt="CCSearch Logo" class="logo">
        <h2>Welcome to CCSearch</h2>
    ...
    <div class="right-section">
      ...
      <div class="quote">
        <h3>Share credible knowledge.<br>Search reliable sources.</h3>
      </div>
    </div>
  </div>
</body>
